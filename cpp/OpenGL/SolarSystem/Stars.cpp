...
void Star::drawStar() 
{
	...
	{
		//satallite
		if (_parentStar != nullptr && 
			_parentStar->_distance > 0)
		{   
...
Planet::Planet(	GLfloat radius,
		...
		Star *parentStar,
		GLfloat rgbColor[]):
	Star(radius, distance, speed,
		selfSpeed, parentStar) 
{
	for (int i = 0; i < 3; ++i)
...
void Planet::drawPlanet() 
{
	...
	GLfloat mat_emission[] = { _rgbColor[0], _rgbColor[1],
		_rgbColor[2], _rgbColor[3] };
