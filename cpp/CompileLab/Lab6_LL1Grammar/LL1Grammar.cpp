...
//230	28	E:\Code\Dev-C++5.11\CompileLab\Lab5_LL1Grammer\LL1Grammar.cpp	[Error] passing 'const std::map<std::pair<char, std::basic_string<char> >, std::unordered_set<char> >' as 'this' argument of 'std::map<_Key, _Tp, _Compare, _Alloc>::mapped_type& std::map<_Key, _Tp, _Compare, _Alloc>::operator[](const key_type&) [with _Key = std::pair<char, std::basic_string<char> >; _Tp = std::unordered_set<char>; _Compare = std::less<std::pair<char, std::basic_string<char> > >; _Alloc = std::allocator<std::pair<const std::pair<char, std::basic_string<char> >, std::unordered_set<char> > >; std::map<_Key, _Tp, _Compare, _Alloc>::mapped_type = std::unordered_set<char>; std::map<_Key, _Tp, _Compare, _Alloc>::key_type = std::pair<char, std::basic_string<char> >]' discards qualifiers [-fpermissive]
